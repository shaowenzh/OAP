...
public class ParquetFileReader implements Closeable {
  ...
  protected final ParquetMetadataConverter converter;
  ...
  protected final FileMetaData fileMetaData; // may be null
  ...
  protected List<BlockMetaData> blocks;
  ...
  class WorkaroundChunk extends Chunk {
     ...
     */
    protected WorkaroundChunk(ChunkDescriptor descriptor, byte[] data, int offset, SeekableInputStream f) {
  ...
  static class ChunkDescriptor {
    ...
    protected final ColumnChunkMetaData metadata;
